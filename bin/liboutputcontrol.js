...
var chalk, os, DaemonPlugin, OutputControl;
chalk = require('chalk');
os = require('os');
DaemonPlugin = global.DaemonPlugin;
OutputControl = (function(superclass){
  var prototype = extend$((import$(OutputControl, superclass).displayName = 'OutputControl', OutputControl), superclass).prototype, constructor = OutputControl;
  function OutputControl(){
    this.install();
  }
  prototype.configure = function(it){
    it.option('-c, --no-color', 'disable colors in the output');
    it.option('-v, --verbose', 'displays debugging information');
    it.option('-w, --warnings', 'displays optional warnings, useful for debugging');
    return it.option('-s, --silent', 'silences both all nonessential and essential output');
  };
